# python 초해상화.py--model-name edsr --model-config '/home/user/WindowsShare/05. Data/03. Checkpoints/hardnegative/SuperResolution/PSOnly/edsr_x4c64b16_1xb16-300k_div2k/edsr_x4c64b16_1xb16-300k_div2k.py' --model-ckpt '/home/user/WindowsShare/05. Data/03. Checkpoints/hardnegative/SuperResolution/PSOnly/edsr_x4c64b16_1xb16-300k_div2k/iter_best.pth' --img-dir '예시이미지' --result-out-dir '예시이미지/출력이미지'
    ...
    if args.img_dir:
        ...
        for img_name in os.listdir(args.img_dir):
            ...
            if img_path.lower().endswith(('.png', '.jpg', '.jpeg')):
                output_path = os.path.join(args.result_out_dir, img_name)from argparse import ArgumentParser
from mmengine import DictAction
from mmagic.apis import MMagicInferencer
import os
