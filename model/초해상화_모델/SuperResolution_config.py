...
data_root = '/home/user/WindowsShare/05. Data/04. Raw Images & Archive/206.hardnegative/학습데이터/실제촬영이미지/SRData_total'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/home/user/WindowsShare/05. Data/04. Raw Images & Archive/206.hardnegative/학습데이터/실제촬영이미지/SRData_total/train/meta_info_train.txt',
        data_prefix=dict(gt='train/HR', img='train/LR'),
        data_root=
        '/home/user/WindowsShare/05. Data/04. Raw Images & Archive/206.hardnegative/학습데이터/실제촬영이미지/SRData_total',
        ...
        pipeline=[
            ...
            dict(gt_patch_size=196, type='PairedRandomCrop'),
            dict(
...
val_dataloader = dict(
    dataset=dict(
        data_prefix=dict(gt='val/HR', img='val/LR'),
        data_root=
        '/home/user/WindowsShare/05. Data/04. Raw Images & Archive/206.hardnegative/학습데이터/실제촬영이미지/SRData_total',
        metainfo=dict(dataset_type='set5', task_name='sisr'),
        pipeline=[
